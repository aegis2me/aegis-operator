"""Vendored shim -- the SINGLE SOURCE OF TRUTH is shared/scoring.py. No logic here; loads the canonical
...
_NAME = "aegis_shared_scoring"
_mod = _sys.modules.get(_NAME)
if _mod is None:
    _path = _os.path.join(_os.path.dirname(_os.path.abspath(__file__)), "..", "shared", "scoring.py")
